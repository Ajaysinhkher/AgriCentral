...
<div class="p-6 bg-white rounded-lg shadow-md">
    <div class="flex justify-between items-center mb-4">
        ...
        <div class="flex space-x-2">
            ...
            <a href="{{ route('admin.category.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded">+ Add Category</a>
            {{-- <a href="{{ route('admin.category.deleted') }}" class="bg-red-500 text-white px-4 py-2 rounded">🗑  Deleted Categories</a> --}}
    ...
    <table class="w-full border-collapse border border-gray-300">
        ...
        <tbody>
            ...
            <tr class="hover:bg-gray-50 transition">
                ...
                <td class="p-3 border">
                    <a href="{{ route('admin.category.edit', ['id' => $category->id]) }}" class="text-blue-500 hover:underline mr-2">✏ Edit</a>
