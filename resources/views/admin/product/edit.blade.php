...
<div class="container mx-auto p-4">
    <div class="bg-white rounded-lg shadow-md max-w-2xl mx-auto p-6">
        ...
        <form id="editProductForm" action="{{ route('admin.product.update', ['id' => $product->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf @method('PUT')
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" id="stock" name="stock" value="{{ $product->stock }}" class="w-full px-3 py-1.5 border rounded text-sm" min="0" required>
                    <span class="error-message text-red-500 text-xs"></span>
                </div>
                <div>
            ...
            <div class="flex justify-end space-x-2 mt-4">
                <a href="{{ route('admin.product.index') }}" class="px-3 py-1 bg-gray-300 text-gray-700 rounded text-xs hover:bg-gray-400">Cancel</a>
