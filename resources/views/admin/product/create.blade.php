        ...
        <form id="productForm" action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-2 gap-4 mt-3">
                ...
                <div>
                    ...
                    <input type="number" name="stock" id="stock" class="w-full px-3 py-1.5 border rounded focus:ring focus:ring-blue-200" min="0" required>
                    <span class="error-message text-red-500 text-xs"></span>
                </div>
                <!-- Status -->
                <div>
            ...
            <div class="flex justify-end space-x-2 mt-5">
                <a href="{{ route('admin.product.store') }}" class="px-3 py-1.5 bg-gray-300 text-gray-700 rounded hover:bg-gray-400 text-sm">Cancel</a>
