...
<body class="min-h-screen flex items-center justify-center bg-gray-100">
    ...
    <div class="max-w-md w-full bg-white p-6 rounded shadow">
        <h2 class="text-2xl font-bold mb-4 text-center text-blue-700">User Login</h2>
        ...
        <a href="{{ route('user.register') }}" class="text-blue-600 hover:underline mt-4 block text-center">
            Register Here!
        </a>
    </div>
